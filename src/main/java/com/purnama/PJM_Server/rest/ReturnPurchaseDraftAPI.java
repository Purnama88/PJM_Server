...
public class ReturnPurchaseDraftAPI {
    ...
    public ResponseEntity<?> getReturnPurchaseDraftList(
        ...
        Pagination<ReturnPurchaseDraft> returnpurchasedraftpagination = new Pagination<>(ls.getTotalPages(), ls.getContent());

        return ResponseEntity.ok(returnpurchasedraftpagination);
    ...
    public ResponseEntity<?> saveReturnPurchaseDraft(HttpServletRequest httpRequest) {
        ...
        returnpurchasedraft.setCreateddate(LocalDateTime.now());
        returnpurchasedraft.setInvoicedate(LocalDateTime.now());
        returnpurchasedraft.setDuedate(LocalDateTime.now());
