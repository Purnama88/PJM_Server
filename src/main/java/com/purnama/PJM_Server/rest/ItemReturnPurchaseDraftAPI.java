...
public class ItemReturnPurchaseDraftAPI {
    ...
    public ResponseEntity<?> getItemReturnPurchaseDraftList(
        ...
        ReturnPurchaseDraft returnpurchasedraft = returnpurchasedraftService.findById(returndraftid).get();
    ...
    public ResponseEntity<?> saveItemReturnPurchaseDraftList(
        ...
        itemreturnpurchasedraftService.saveAll(itemreturnpurchasedraftlist);
